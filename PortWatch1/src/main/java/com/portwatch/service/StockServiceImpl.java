...
public class StockServiceImpl implements StockService {
    ...
    /**
     * 종목 검색 (키워드 + 시장 타입)
     * StockApiController에서 사용
     */
    @Override
    public List<StockVO> searchStocks(String keyword, String marketType) throws Exception {
        // 키워드와 시장 타입 모두 있는 경우
        if (keyword != null && !keyword.isEmpty() && marketType != null && !marketType.isEmpty()) {
        ...
        // 시장 타입만 있는 경우
        else if (marketType != null && !marketType.isEmpty()) {
